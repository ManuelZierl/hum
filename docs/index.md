...
<p align="center">
  <img src="assets/img/logo-transparent.svg" alt="Hum logo" width="120" />
</p>

# Welcome to Hum

Hum is an open-source messenger with Matrix-based infrastructure and Lightning wallet integration.

Use this site to learn how to use, develop, and contribute to Hum.

## Table of Contents

1. **[Overview](overview/index.md)**
   - [What is Hum?](overview/what-is-hum.md)
