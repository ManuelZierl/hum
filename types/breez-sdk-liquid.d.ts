declare module '@breeztech/react-native-breez-sdk-liquid' {
  ...
  export interface PrepareSendResponse {
    destination:
      | {
          type: 'liquidAddress';
          addressData: { address: string; assetId?: string };
        }
      | {
          type: 'bolt11';
          invoice: {
      ...
      | {
          type: 'bolt12';
          offer: { offer: string; receiverAmountSat?: number };
        };
    amount?: PayAmount;
    feesSat?: number;
  ...
  export const prepareReceivePayment: (req: {
    paymentMethod:
      | 'bolt11Invoice'
      | 'bolt12Offer'
      | 'bitcoinAddress'
  ...
  export const parse: (input: string) => Promise<{
    type: string;
    invoice?: {
      bolt11: string;
      description?: string;
